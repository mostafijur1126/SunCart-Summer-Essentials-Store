...
const HeroSection = () => {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-[#FFF9F0] via-[#E8F3EF] to-[#FFF0D3] min-h-[90vh] flex items-center">
          ...
          >
            ...
            >
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center gap-2 text-sm text-[#2C3E3E]/80"
                >
                  <div className="text-[#FFB7A4]">{item.icon}</div>
                  <span>{item.text}</span>
                </div>
              ))}
            </motion.div>
